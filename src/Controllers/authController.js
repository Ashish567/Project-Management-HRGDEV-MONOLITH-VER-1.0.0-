...
const userSchemaValidate = require('../Schema/userScemaValidate');
...
exports.signup = catchAsync(async (req, res, next) => {
  var result = joiValidate({ ...req.body });
  ...
  try {
    ...
    res.status(200).json({
      status: 'success',
      message: 'Password Set Link Token sent to email!'
    });
  } catch (err) {
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  const password = await bcrypt.hash(req.body.password.toString(), 12);
